...
(function() {
    ...
    function createElements() {
        ...
        // Remove existing
        document.querySelectorAll('.sff-clean-btn, .sff-clean-panel, .sff-stats-counter').forEach(el => el.remove());
        ...
        // Create stats counter outside panel
        const stats = document.createElement('div');
        stats.className = 'sff-stats-counter';
        stats.textContent = 'Ready to filter';
        ...
        setupEvents(btn, panel, stats);
        return { btn, panel, stats };
    }

    function setupEvents(btn, panel, stats) {
    ...
    function filterActivities() {
        ...
        const statsEl = document.querySelector('.sff-stats-counter');
        if (statsEl) statsEl.textContent = `Hidden: ${hiddenCount}`;
    }
    ...
    function init() {
        ...
        setTimeout(() => {
            createElements();
            if (settings.enabled) filterActivities();
        }, 1500);
    }
